...
export const brand: Brand = {
  name: "Flo Skin Therapy",
  shortName: "Flo Skin",
  microTag: "LUXURY SKIN AND BODY WELLNESS",
  description:
    "Flo Skin Therapy in Accra treats skin with patience and skill — facials and targeted treatments with results you can see.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0205252852",
    phoneTel: "+233205252852",
    textPhone: "0205252852",
    textPhoneTel: "+233205252852",
    email: "hello@floskin.test",
    privacyEmail: "privacy@floskin.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@floskintherapist", icon: "tiktok" },
  ],
  ...
  hero: {
    badge: "Now booking",
    title: "skin therapy,\nflo-state calm.\nLuxury skin and body wellness.",
    subtitle:
      "Facials and skin treatments in Accra — book your consultation today",
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "That is the gap Flo Skin Therapy was built for: honest treatments, fair prices, and a space that treats your time with respect.",
    ...
    images: [
      {
        ...
        alt: "Flo Skin Therapy beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Flo Skin Therapy self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Flo Skin Therapy beauty ritual",
      ...
      },
      {
        ...
        alt: "Flo Skin Therapy calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Flo Skin Therapy relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Flo Skin Therapy beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Flo Skin Therapy lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Flo Skin Therapy mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Flo Skin Therapy makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Flo Skin Therapy foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@floskintherapist",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783488433/stage4/spa_floskintherapist/tiktok_0.mp4",
        alt: "Flo Skin Therapy treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783488445/stage4/spa_floskintherapist/tiktok_1.mp4",
        alt: "Flo Skin Therapy treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783488449/stage4/spa_floskintherapist/tiktok_2.mp4",
        alt: "Flo Skin Therapy treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Flo Skin Therapy self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Flo Skin Therapy studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Flo Skin Therapy",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Flo Skin Therapy is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0205252852 and text 0205252852 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0205252852, text 0205252852, or message @floskintherapist on Instagram." },
          ...
          { q: "Where are you located?", a: "Flo Skin Therapy is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@floskin.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Flo Skin Therapy (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@floskin.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Flo Skin Therapy is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@floskin.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Flo Skin Therapy",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0205252852", href: "tel:+233205252852" },
      { label: "Text", value: "0205252852", href: "sms:+233205252852" },
      { label: "Instagram", value: "@floskintherapist", href: "https://www.tiktok.com/@floskintherapist" },
    ],
  },
  ...
  footer: {
    blurb:
      "Flo Skin Therapy in Accra — luxury skin and body wellness.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@floskintherapist" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0205252852", href: "tel:+233205252852" },
          { label: "Text 0205252852", href: "sms:+233205252852" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Flo Skin Therapy — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
