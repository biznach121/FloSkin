  ...
  return (
    <section className="spabox-page">
      <div className="spabox-shell max-w-[760px] text-center">
        ...
        {error.digest && (
          <p className="mt-6 text-xs font-mono text-[#5a2c30]/60">
            Reference: <code className="text-[#4e1b22]">{error.digest}</code>
          </p>
        )}
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="inline-flex min-h-14 items-center justify-center border border-[#4e1b22]/18 px-7 text-sm font-semibold text-[#4e1b22] transition-colors hover:bg-[#e4cfb9]"
          >
            Back home
          </Link>
        </div>
