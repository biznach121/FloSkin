...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783488424/stage4/spa_floskintherapist/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Flo Skin Therapy - Luxury skin and body wellness">
        <Image
          src={src}
          alt="Flo Skin Therapy - Luxury skin and body wellness"
          fill
