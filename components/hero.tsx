...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#76250b] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#862a16]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(78, 18, 4,0.58),rgba(106, 11, 1,0.22)_43%,rgba(79, 23, 8,0.34)),linear-gradient(0deg,rgba(41, 13, 6,0.18),rgba(41, 13, 6,0.08))]" />
