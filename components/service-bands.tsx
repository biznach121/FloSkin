...
export function ServiceBands() {
  return (
    <section className="h-svh bg-[#efe3d7] px-1 pb-1 text-white">
      <div className="mx-auto grid h-full max-w-[1680px] grid-rows-3 overflow-hidden">
        {brand.serviceBands.map((service) => (
          <article
            key={service.title}
            className="group relative min-h-0 overflow-hidden border-t-[18px] border-[#efe3d7] first:border-t-0"
          >
            <Image
              src={service.image}
              ...
              unoptimized
            />
            <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(55, 10, 14,0.52),rgba(55, 10, 14,0.18)_36%,rgba(55, 10, 14,0.02)_72%)]" />
